...
export const styles = StyleSheet.create({
  ...
  pillOwnerText: { color: '#86EFAC', fontWeight: '900', fontSize: 12 },
  pillStatus: {
    paddingHorizontal: 10,
    paddingVertical: 6,
    borderRadius: 999,
  ...
  pillStatusText: { fontWeight: '800', fontSize: 12 },
  pillStatusTextOpen: { color: '#93C5FD' },
  pillStatusTextClosed: { color: colors.textSecondary },
  pillHot: {
    paddingHorizontal: 10,
    paddingVertical: 6,
    borderRadius: 999,
  ...
  pillHotText: { color: '#FDE047', fontWeight: '900', fontSize: 12 },
  ownerCloseChip: {
    flexDirection: 'row-reverse',
    alignItems: 'center',
    gap: 6,
